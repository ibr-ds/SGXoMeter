...
enum
{
    OETestEnclave_fcn_id_new_thread_func = 0,
    OETestEnclave_fcn_id_ecall_start_bench = 1,
    OETestEnclave_fcn_id_ecall_pause_bench = 2,
    OETestEnclave_fcn_id_ecall_stop_bench = 3,
    OETestEnclave_fcn_id_ecall_cleanup_bench = 4,
    OETestEnclave_fcn_id_ecall_run_bench = 5,
    OETestEnclave_fcn_id_ecall_run_bench_with_transitions = 6,
    OETestEnclave_fcn_id_ecall_set_config = 7,
    OETestEnclave_fcn_id_oe_get_sgx_report_ecall = 8,
    OETestEnclave_fcn_id_oe_get_report_v2_ecall = 9,
    OETestEnclave_fcn_id_oe_verify_local_report_ecall = 10,
    OETestEnclave_fcn_id_oe_sgx_init_context_switchless_ecall = 11,
    OETestEnclave_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 12,
    OETestEnclave_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** Trusted function names. ****/
static const oe_ecall_info_t _OETestEnclave_ecall_info_table[] = 
{
    { "new_thread_func" },
    { "ecall_start_bench" },
    { "ecall_pause_bench" },
    ...
    { "ecall_cleanup_bench" },
    { "ecall_run_bench" },
    { "ecall_run_bench_with_transitions" },
    { "ecall_set_config" },
...
typedef struct _new_thread_func_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} new_thread_func_args_t;

typedef struct _ecall_start_bench_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_start_bench_args_t;

typedef struct _ecall_pause_bench_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_pause_bench_args_t;

typedef struct _ecall_stop_bench_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_stop_bench_args_t;

typedef struct _ecall_cleanup_bench_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} ecall_cleanup_bench_args_t;

typedef struct _ecall_run_bench_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int test_id;
    int thread_id;
} ecall_run_bench_args_t;

typedef struct _ecall_run_bench_with_transitions_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int test_id;
    int thread_id;
} ecall_run_bench_with_transitions_args_t;

typedef struct _ecall_set_config_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
oe_result_t OETestEnclave_new_thread_func(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    new_thread_func_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(new_thread_func_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(new_thread_func_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (new_thread_func_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_new_thread_func].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (new_thread_func_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(OETestEnclave_new_thread_func, new_thread_func);

oe_result_t OETestEnclave_ecall_start_bench(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_start_bench_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_start_bench_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_start_bench_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_start_bench_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_start_bench].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_start_bench_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_start_bench, ecall_start_bench);

oe_result_t OETestEnclave_ecall_pause_bench(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_pause_bench_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pause_bench_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pause_bench_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pause_bench_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_pause_bench].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pause_bench_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_pause_bench, ecall_pause_bench);

oe_result_t OETestEnclave_ecall_stop_bench(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_stop_bench_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_stop_bench_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_stop_bench_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_stop_bench_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_stop_bench].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_stop_bench_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_stop_bench, ecall_stop_bench);

oe_result_t OETestEnclave_ecall_cleanup_bench(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    /* Marshalling struct. */
    ecall_cleanup_bench_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_cleanup_bench_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_cleanup_bench_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_cleanup_bench_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_cleanup_bench].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_cleanup_bench_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_cleanup_bench, ecall_cleanup_bench);

oe_result_t OETestEnclave_ecall_run_bench(
    ...
    int thread_id)
{
    ...
    /* Marshalling struct. */
    ecall_run_bench_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.test_id = test_id;
    _args.thread_id = thread_id;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_run_bench_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_run_bench_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_run_bench_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_run_bench].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_run_bench_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_run_bench, ecall_run_bench);

oe_result_t OETestEnclave_ecall_run_bench_with_transitions(
    oe_enclave_t* enclave,
    int test_id,
    int thread_id)
{
    ...
    /* Marshalling struct. */
    ecall_run_bench_with_transitions_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_run_bench_with_transitions_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_run_bench_with_transitions_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_run_bench_with_transitions_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_run_bench_with_transitions].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_run_bench_with_transitions_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_run_bench_with_transitions, ecall_run_bench_with_transitions);

oe_result_t OETestEnclave_ecall_set_config(
    oe_enclave_t* enclave,
    uint64_t** ctr,
    void* globalConfig)
{
    ...
    /* Marshalling struct. */
    ecall_set_config_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.ctr = (uint64_t**)ctr;
    _args.globalConfig = (void*)globalConfig;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_set_config_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_set_config_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_set_config_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_ecall_set_config].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_set_config_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(OETestEnclave_ecall_set_config, ecall_set_config);

oe_result_t OETestEnclave_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(OETestEnclave_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t OETestEnclave_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(OETestEnclave_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t OETestEnclave_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(OETestEnclave_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t OETestEnclave_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(OETestEnclave_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t OETestEnclave_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _OETestEnclave_ecall_info_table[OETestEnclave_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(OETestEnclave_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);

/**** Untrusted function IDs. ****/
enum
{
    OETestEnclave_fcn_id_uprint = 0,
    OETestEnclave_fcn_id_ocallMalloc = 1,
    OETestEnclave_fcn_id_ocallFree = 2,
    OETestEnclave_fcn_id_usgx_exit = 3,
    OETestEnclave_fcn_id_ucreate_thread = 4,
    OETestEnclave_fcn_id_oe_syscall_epoll_create1_ocall = 5,
    OETestEnclave_fcn_id_oe_syscall_epoll_wait_ocall = 6,
    OETestEnclave_fcn_id_oe_syscall_epoll_wake_ocall = 7,
    OETestEnclave_fcn_id_oe_syscall_epoll_ctl_ocall = 8,
    OETestEnclave_fcn_id_oe_syscall_epoll_close_ocall = 9,
    OETestEnclave_fcn_id_oe_syscall_open_ocall = 10,
    OETestEnclave_fcn_id_oe_syscall_read_ocall = 11,
    OETestEnclave_fcn_id_oe_syscall_write_ocall = 12,
    OETestEnclave_fcn_id_oe_syscall_readv_ocall = 13,
    OETestEnclave_fcn_id_oe_syscall_writev_ocall = 14,
    OETestEnclave_fcn_id_oe_syscall_lseek_ocall = 15,
    OETestEnclave_fcn_id_oe_syscall_pread_ocall = 16,
    OETestEnclave_fcn_id_oe_syscall_pwrite_ocall = 17,
    OETestEnclave_fcn_id_oe_syscall_close_ocall = 18,
    OETestEnclave_fcn_id_oe_syscall_flock_ocall = 19,
    OETestEnclave_fcn_id_oe_syscall_fsync_ocall = 20,
    OETestEnclave_fcn_id_oe_syscall_fdatasync_ocall = 21,
    OETestEnclave_fcn_id_oe_syscall_dup_ocall = 22,
    OETestEnclave_fcn_id_oe_syscall_opendir_ocall = 23,
    OETestEnclave_fcn_id_oe_syscall_readdir_ocall = 24,
    OETestEnclave_fcn_id_oe_syscall_rewinddir_ocall = 25,
    OETestEnclave_fcn_id_oe_syscall_closedir_ocall = 26,
    OETestEnclave_fcn_id_oe_syscall_stat_ocall = 27,
    OETestEnclave_fcn_id_oe_syscall_fstat_ocall = 28,
    OETestEnclave_fcn_id_oe_syscall_access_ocall = 29,
    OETestEnclave_fcn_id_oe_syscall_link_ocall = 30,
    OETestEnclave_fcn_id_oe_syscall_unlink_ocall = 31,
    OETestEnclave_fcn_id_oe_syscall_rename_ocall = 32,
    OETestEnclave_fcn_id_oe_syscall_truncate_ocall = 33,
    OETestEnclave_fcn_id_oe_syscall_ftruncate_ocall = 34,
    OETestEnclave_fcn_id_oe_syscall_mkdir_ocall = 35,
    OETestEnclave_fcn_id_oe_syscall_rmdir_ocall = 36,
    OETestEnclave_fcn_id_oe_syscall_fcntl_ocall = 37,
    OETestEnclave_fcn_id_oe_syscall_ioctl_ocall = 38,
    OETestEnclave_fcn_id_oe_syscall_poll_ocall = 39,
    OETestEnclave_fcn_id_oe_syscall_kill_ocall = 40,
    OETestEnclave_fcn_id_oe_syscall_close_socket_ocall = 41,
    OETestEnclave_fcn_id_oe_syscall_socket_ocall = 42,
    OETestEnclave_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 43,
    OETestEnclave_fcn_id_oe_syscall_socketpair_ocall = 44,
    OETestEnclave_fcn_id_oe_syscall_connect_ocall = 45,
    OETestEnclave_fcn_id_oe_syscall_accept_ocall = 46,
    OETestEnclave_fcn_id_oe_syscall_bind_ocall = 47,
    OETestEnclave_fcn_id_oe_syscall_listen_ocall = 48,
    OETestEnclave_fcn_id_oe_syscall_recvmsg_ocall = 49,
    OETestEnclave_fcn_id_oe_syscall_sendmsg_ocall = 50,
    OETestEnclave_fcn_id_oe_syscall_recv_ocall = 51,
    OETestEnclave_fcn_id_oe_syscall_recvfrom_ocall = 52,
    OETestEnclave_fcn_id_oe_syscall_send_ocall = 53,
    OETestEnclave_fcn_id_oe_syscall_sendto_ocall = 54,
    OETestEnclave_fcn_id_oe_syscall_recvv_ocall = 55,
    OETestEnclave_fcn_id_oe_syscall_sendv_ocall = 56,
    OETestEnclave_fcn_id_oe_syscall_shutdown_ocall = 57,
    OETestEnclave_fcn_id_oe_syscall_setsockopt_ocall = 58,
    OETestEnclave_fcn_id_oe_syscall_getsockopt_ocall = 59,
    OETestEnclave_fcn_id_oe_syscall_getsockname_ocall = 60,
    OETestEnclave_fcn_id_oe_syscall_getpeername_ocall = 61,
    OETestEnclave_fcn_id_oe_syscall_getaddrinfo_open_ocall = 62,
    OETestEnclave_fcn_id_oe_syscall_getaddrinfo_read_ocall = 63,
    OETestEnclave_fcn_id_oe_syscall_getaddrinfo_close_ocall = 64,
    OETestEnclave_fcn_id_oe_syscall_getnameinfo_ocall = 65,
    OETestEnclave_fcn_id_oe_syscall_nanosleep_ocall = 66,
    OETestEnclave_fcn_id_oe_syscall_clock_nanosleep_ocall = 67,
    OETestEnclave_fcn_id_oe_syscall_getpid_ocall = 68,
    OETestEnclave_fcn_id_oe_syscall_getppid_ocall = 69,
    OETestEnclave_fcn_id_oe_syscall_getpgrp_ocall = 70,
    OETestEnclave_fcn_id_oe_syscall_getuid_ocall = 71,
    OETestEnclave_fcn_id_oe_syscall_geteuid_ocall = 72,
    OETestEnclave_fcn_id_oe_syscall_getgid_ocall = 73,
    OETestEnclave_fcn_id_oe_syscall_getegid_ocall = 74,
    OETestEnclave_fcn_id_oe_syscall_getpgid_ocall = 75,
    OETestEnclave_fcn_id_oe_syscall_getgroups_ocall = 76,
    OETestEnclave_fcn_id_oe_syscall_uname_ocall = 77,
    OETestEnclave_fcn_id_oe_get_supported_attester_format_ids_ocall = 78,
    OETestEnclave_fcn_id_oe_get_qetarget_info_ocall = 79,
    OETestEnclave_fcn_id_oe_get_quote_ocall = 80,
    OETestEnclave_fcn_id_oe_get_quote_verification_collateral_ocall = 81,
    OETestEnclave_fcn_id_oe_verify_quote_ocall = 82,
    OETestEnclave_fcn_id_oe_sgx_get_cpuid_table_ocall = 83,
    OETestEnclave_fcn_id_oe_sgx_backtrace_symbols_ocall = 84,
    OETestEnclave_fcn_id_oe_sgx_thread_wake_wait_ocall = 85,
    OETestEnclave_fcn_id_oe_sgx_wake_switchless_worker_ocall = 86,
    OETestEnclave_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 87,
    OETestEnclave_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

/**** OCALL marshalling structs. ****/
typedef struct _uprint_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _ocallMalloc_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _ocallFree_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _usgx_exit_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _ucreate_thread_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
} ucreate_thread_args_t;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    uprint_args_t* _pargs_in = (uprint_args_t*)input_buffer;
    uprint_args_t* _pargs_out = (uprint_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocallMalloc_args_t* _pargs_in = (ocallMalloc_args_t*)input_buffer;
    ocallMalloc_args_t* _pargs_out = (ocallMalloc_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ocallMalloc(
        _pargs_in->size);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocallFree_args_t* _pargs_in = (ocallFree_args_t*)input_buffer;
    ocallFree_args_t* _pargs_out = (ocallFree_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    usgx_exit_args_t* _pargs_in = (usgx_exit_args_t*)input_buffer;
    usgx_exit_args_t* _pargs_out = (usgx_exit_args_t*)output_buffer;
...
static void ocall_ucreate_thread(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ucreate_thread_args_t* _pargs_in = (ucreate_thread_args_t*)input_buffer;
    ucreate_thread_args_t* _pargs_out = (ucreate_thread_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ucreate_thread(
    );
...
static oe_ocall_func_t _OETestEnclave_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_uprint,
    (oe_ocall_func_t) ocall_ocallMalloc,
    (oe_ocall_func_t) ocall_ocallFree,
    (oe_ocall_func_t) ocall_usgx_exit,
    (oe_ocall_func_t) ocall_ucreate_thread,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _OETestEnclave_ocall_function_table,
               88,
               _OETestEnclave_ecall_info_table,
                13,
               enclave);
}
