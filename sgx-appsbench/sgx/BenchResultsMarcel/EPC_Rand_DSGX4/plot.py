...
plt.xlabel('In-enclave read buffer size')
plt.xticks(x,('1 MiB','2 MiB','4 MiB','8 MiB','16 MiB','32 MiB','64 MiB','128 MiB','256 MiB','512 MiB','1 GiB'), rotation='vertical')
...
plt.legend()
plt.tight_layout()
plt.savefig("EPC_RAND_DSGX4.pdf")
#plt.show()
