...
f= open("SHA256_DSGX4.txt","w+") # Zum Nachrechnen der Werte aus der BA einfach alle Werte unter 8KiB temporär löschen ;)
f.write("SGX: %f" % (((1-(resultSGX/len(sgx)))+ (1-(resultOE/len(oe)))+ (1-(resultGraphene/len(graphene))))/3 ))
f.close()
