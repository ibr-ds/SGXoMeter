...
plt.plot(x,graphene,'g:',label='GrapheneSGX')
...
plt.title('SGXSDK AES GCM Decryption & Encryption on in-enclave Buffers Benchmark')
plt.legend()
plt.tight_layout()
plt.savefig("dencrypto.pdf")
#plt.show()
