...
plt.ylabel('#completed DNA oattern matching operations')
plt.title('Plot of the benchmark DNA pattern matching of Seeq with ocalls')
plt.legend()
plt.tight_layout()
plt.savefig("DnawithOcalls.pdf")
plt.show()
